...
%     'numBins' - extractHOGFeatures numBins.
    ...
    if noTranslations > 0
        ...
        for i = -noTranslations : noTranslations
            for j = -noTranslations : noTranslations
                ...
                tacData.rec(ind) = recognizeRimByHOG(classifier, img1, varargin{:}, 'rimXY', tacData.data(ind).rXY, 'rimRadius', tacData.data(ind).rD / 2);
        ...
        tacData.rec(1) = recognizeRimByHOG(classifier, img, varargin{:}, 'rimXY', tacData.data(1).rXY, 'rimRadius', tacData.data(1).rD / 2);
    end
    ...
    for f = ["rD", "chD", "chC", "sD", "sQ", "pcD", "pcC", "vD", "vA", "tim"]
